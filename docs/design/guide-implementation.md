...
> un flavor de démonstration dans `runtime/reference/arena` — un seul exécutable.
...
- **Séparation vérificateur (R2)** : jamais `runtime/verification/testkit/` dans le même commit
...
| rév.   | changement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **r4** | **Bascule achevée** : le testkit juge `mumble-server-runtime-gateway` et `mumble-server-runtime-shard`, l'ancien pipeline P5–P7 est retiré et `legacy-p7-final` devient son archive. Un `ChannelId` accepté comme retiré par un client est désormais mort globalement (§18), y compris lors d'un simple changement de portée.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
Écarts délibérés entre ce document et `mumble-server-runtime-shard`. Chacun est motivé, et
