...
FORBIDDEN=(
  ...
  "mumble-server-runtime-protocol|voxloom-shard"
  "mumble-server-runtime-protocol|voxloom-gateway"
  "mumble-server-runtime-crypto|voxloom-shard"
  "mumble-server-runtime-crypto|voxloom-gateway"
  "voxloom-shard|mumble-server-runtime-crypto"
